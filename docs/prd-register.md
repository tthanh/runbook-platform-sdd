...
| 3 | 03-runbook-execution | Run a published version against an incident: pin the version, record every step as it happens, compute the review from the records | Registered |
...
| 03-runbook-execution | Inherited 2026-06-13 (Go) — deferred payoff half of 01 | Inherited from 01; 5 terms (Execution, Version Pin, Step Record, Computed Review, Incident) pending human ratification; hotspots H2/H3/H5 → ADRs, H4 → spike | — (pending /speckit.plan) | — (pending /speckit.specify) | — | — |
