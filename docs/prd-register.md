...
| 4 | 04-rich-steps | Enrich a Step beyond a single title — structured detail (instructions, command, expected result) and a step type — so a published runbook is executable, not a list of vague titles. Branching deferred to a later initiative. | Workshop |
...
| 04-rich-steps | Finalized 2026-06-15 (Go) — new problem (thin Step surfaced by dogfooding); appetite a couple of evenings, branching explicitly OUT | RUN 2026-06-15 (compiled) — proposes redefining **Step** + new term **Step Type**; **awaiting human ratification before PRD** (not yet in constitution); no new events; H1–H5 carried (H2 markdown/XSS, H3 Step Type taxonomy, H4 C-002 migration, H5 branching-deferred boundary) | — (drafted at /speckit.plan) | — | — | — |
