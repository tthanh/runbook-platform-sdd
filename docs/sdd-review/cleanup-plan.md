...
| 6 | Trim the unused "outbox / no dual-writes" rule from the constitution | ✅ Done (applied with flip condition on human instruction 2026-06-28) | .specify/memory/constitution.md |
